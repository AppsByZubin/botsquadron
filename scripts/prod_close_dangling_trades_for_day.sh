...
BOT_WORKLOAD_PATTERN="${BOT_WORKLOAD_PATTERN:-solobot|trendobot|haemabot|hemabot|firebot|fibobot}"
BOT_POD_PATTERN="${BOT_POD_PATTERN:-solobot|trendobot|haemabot|hemabot|firebot|fibobot}"
