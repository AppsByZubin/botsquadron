...
func (b *Business) BlockBotOrders(ctx context.Context, botName string, req model.BlockBotOrdersRequest) (model.BotKillSwitchResponse, error) {
	return b.svc.BlockBotOrders(ctx, botName, req)
}
