...
# -*- coding: utf-8 -*-
"""
Command-line entrypoint for titanbot.
"""
...
TITANBOT_DIR = pathlib.Path(__file__).resolve().parent
sys.path.insert(0, str(TITANBOT_DIR))

from common import constants
from logger import create_logger

logger = create_logger("TitanBotMain")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run titanbot.")
    parser.add_argument(
        "-i",
        "--instruments",
    ...
    parser.add_argument(
        ...
        help="Execution mode fallback when TITANBOT_MODE is not set.",
    )
