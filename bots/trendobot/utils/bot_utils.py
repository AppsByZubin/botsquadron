...
K8S_PARAM_ENV_KEYS = (
    "TRENDOBOT_PARAM_YAML",
    "TRENDOBOT_PARAMS_YAML",
    "TRENDOBOT_PARAM_DATA",
    "TRENDOBOT_PARAMS",
    "SOLOBOT_PARAM_YAML",
    "SOLOBOT_PARAMS_YAML",
    "SOLOBOT_PARAM_DATA",
...
K8S_PARAM_FILE_ENV_KEYS = (
    "TRENDOBOT_PARAM_FILE",
    "TRENDOBOT_PARAM_PATH",
    "SOLOBOT_PARAM_FILE",
    "SOLOBOT_PARAM_PATH",
    "PARAM_FILE",
    "PARAM_PATH",
...
def _normalize_bot_id(value: str) -> str:
    ...
    return normalized or "trendobot"
