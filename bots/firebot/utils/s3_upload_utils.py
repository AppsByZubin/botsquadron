...
# -*- coding: utf-8 -*-
"""
Optional S3 upload hooks for firebot trade artifacts.
"""
...
def maybe_upload_trade_artifacts_to_s3(bot_name: str, execution_mode: str) -> None:
    if not _to_bool(os.getenv("FIREBOT_UPLOAD_ARTIFACTS", "")):
        logger.info("Skipping S3 upload. Set FIREBOT_UPLOAD_ARTIFACTS=true to enable it.")
        return
