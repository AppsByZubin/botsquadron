...
# -*- coding: utf-8 -*-
"""
Command-line entrypoint for meanbot.
"""
...
MEANBOT_DIR = pathlib.Path(__file__).resolve().parent
sys.path.insert(0, str(MEANBOT_DIR))

from common import constants
from logger import create_logger

logger = create_logger("MeanbotMain")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run meanbot.")
    parser.add_argument(
        "-i",
        "--instruments",
    ...
    parser.add_argument(
        ...
        help="Execution mode fallback when MEANBOT_MODE is not set.",
    )
    ...
    if did_run is False:
        ...
        upload_trade_artifacts_to_s3(bot_name="meanbot", execution_mode=mode)
